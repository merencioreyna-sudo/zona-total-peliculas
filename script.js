...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyIeLDKepN5sr5z8R4IytbuixlXeZKlLkUOZoe80NPnIwj-XdrwkRfiyXEUHn1RfNLy2A/exec";
    ...
    enlaces.forEach(link => {
        ...
        link.addEventListener('click', function(e) {
            ...
            if (accessData.estado !== "activo" && accessData.rol !== "admin") {
                e.preventDefault();
                showNotification("⚠ Tu cuenta aún no está activada");
                return;
            }
...
if (btnCrearCuenta) {
    ...
    btnCrearCuenta.addEventListener("click", function() {
        ...
        const comprobante = document.getElementById("reg-comprobante").files[0];
...
reader.onload = function() {
    ...
    datosUsuario.comprobanteBase64 = base64;
    datosUsuario.nombreArchivo = comprobante.name;
...
.then(data => {
    ...
    alert("Cuenta creada. Espera la activación del administrador.");
